...
<div class="col-xxl-6 col-xl-6 col-lg-12">
    <div class="row g-4">
        ...
        <div class="col-12 mb-3">
            <div class="trail-bg h-100 text-center d-flex flex-column justify-content-between align-items-center p-4 radius-8">
    ...
    <h6 class="mb-3 mt-4">Bookfair Orders (Inprogress)</h6>
