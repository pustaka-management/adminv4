...
<div class="container-fluid">
    ...
    <div class="d-flex flex-wrap gap-3 mb-4">
        ...
        $cards = [
            ...
            ['title'=>'Total Orders','val'=>number_format($summary['total_orders'] ?? 0),'icon'=>'mdi:clipboard-list','bg'=>'info','extra'=>true],
            ['title'=>'Revenue (INR)','val'=>'₹ '.number_format($summary['total_revenue'] ?? 0,2),'icon'=>'mdi:cash','bg'=>'warning','extra'=>true],
        ];
        ?>
...
<script>
const ctx = document.getElementById('storytelLangChart').getContext('2d');
