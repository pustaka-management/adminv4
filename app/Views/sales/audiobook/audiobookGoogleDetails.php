    ...
    <div class="row g-3">
        ...
        <div class="col-lg-6">
            <div class="card radius-8 border shadow-sm h-100">
                <div class="card-body">
                    <h5 class="fw-bold mb-3">Top Google Audiobooks</h5>
            ...
            <div class="card radius-8 border shadow-sm h-100">
                <div class="card-body">
                    ...
                    <div style="height:320px">
                        <canvas id="googleAudioLangChart"></canvas>
                    </div>
                </div>
            </div>
        </div>
...
<script>
const ctx = document.getElementById('googleAudioLangChart').getContext('2d');
