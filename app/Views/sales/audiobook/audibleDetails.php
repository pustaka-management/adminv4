...
<div class="container-fluid">
    ...
    <div class="d-flex flex-wrap gap-3 mb-4">
        ...
        $cards = [
            ...
            [
                'title' => 'Revenue (INR)',
                'value' => '₹ '.number_format($summary['total_net_sales'] ?? 0, 2),
                'icon'  => 'mdi:cash',
                'bg'    => 'warning',
                'extra' => 'revenue'
            ],
            ...
            <div class="card px-24 py-16 radius-8 border shadow-sm h-100">
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div>
                        ...
                        <h6 class="fw-bold mb-1"><?= $c['value'] ?></h6>

                        <?php if (($c['extra'] ?? '') === 'orders'): ?>
...
<?php
// ✅ Only languages with sales > 0
$langs = [];
$vals  = [];

foreach ($languageSales ?? [] as $row) {
    if (!empty($row['total_sales']) && $row['total_sales'] > 0) {
        $langs[] = $row['language_name'];
        $vals[]  = (float)$row['total_sales'];
    }
}
?>
